...
export function Footer() {
  ...
  const legalLinks = [
    { href: 'https://api.gastandoya.com.br/privacy', label: 'Politica de Privacidade' },
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="lg:col-span-2">
            <a href="/" className="flex items-center gap-3 mb-6 group">
              <div className="relative w-12 h-12 rounded-xl overflow-hidden ring-2 ring-emerald-500/20 group-hover:ring-emerald-500/40 transition-all">
                <Image
                  src="/og-image.png"
                  alt="GastandoYa - App de Controle de Gastos"
                  fill
            ...
            <p className="text-neutral-500 max-w-sm leading-relaxed mb-6">
              Controle suas financas de forma inteligente. Planeje, analise e alcance seus objetivos financeiros.
            </p>
            ...
            >
              ...
              <div>
                <div className="text-[10px] text-neutral-500 uppercase tracking-wider leading-none">Disponivel na</div>
        ...
        <div className="pt-8 border-t border-neutral-900 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-neutral-600">
            &copy; {currentYear} GastandoYa. Todos os direitos reservados.
          </p>
